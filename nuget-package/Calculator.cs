...
public static class Calculator
{
    ...
    public static double Hypot(params double[] values){if(values.Length==0)throw new ArgumentException("Hypot requires a value.");double sum=0;foreach(var v in values)sum+=v*v;return Math.Sqrt(sum);}
