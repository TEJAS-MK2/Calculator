class Calculator {
    ...
    animateThemeChange(){if(typeof anime!=='function')return;anime.remove('.calculator,.display-container,.memory-panel,.theme-toggle');anime({targets:'.calculator',scale:[.985,1],duration:450,easing:'easeOutCubic'});anime({targets:'.display-container,.memory-panel',opacity:[.75,1],translateY:[4,0],duration:400,easing:'easeOutCubic'});anime({targets:'.theme-toggle',rotate:[0,360],scale:[.85,1],duration:550,easing:'easeOutBack'});}
}
